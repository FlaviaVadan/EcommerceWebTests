...
private By secondItem= By.xpath("//*[@id=\"entry_212408\"]/div/div[2]/div/div[2]/h4/a");
    ...
    public void clickSubscribeNewsletter() {driver.findElement(subscribeNewsletter).click();}

    public void clickEditYourAccountInformation() {driver.findElement(editYourAccountInformation).click();}

    public void clickViewOrderHistory() {driver.findElement(ViewOrderHistory).click();}

    public void clickModifyWishlist(){driver.findElement(modifyWishlist).click();}
    public void clickShopByCategory() {driver.findElement(shopByCategory).click();}

    public void clickCamerasCategory() {driver.findElement(camerasCategory).click();}

    public void clickFirstItem() {driver.findElement(firstItem).click();}

    public void clickStarButton() {driver.findElement(starButton).click();}

    public void clickWriteReviewButton() {driver.findElement(writeReviewButton).click();}

    public String getWarningMessage() {return driver.findElement(warningMessage).getText();}
    public void clickCompareButtonFirstElement(){driver.findElement(compareButtonFirstElement).click();}
    public void clickCompareButtonSecondElement(){driver.findElement(compareButtonSecondElement).click();}
    public void clickSecondItem(){driver.findElement(secondItem).click();}
    public void clickClosePopupButton() {driver.findElement(closePopupButton).click();}
    ...
    public void clickPlusIcon (){driver.findElement(plusIcon).click();}
    public void clickReturnRequests(){driver.findElement(returnRequests).click();}
    public String getMessageReturn(){return driver.findElement(messageReturn).getText();}
