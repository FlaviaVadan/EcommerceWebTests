...
public class SearchResultsPage extends BasePage {
    ...
    public void clickFirstItem() {driver.findElements(resultItems).get(0).click();}
    public WebElement getFirstItem() {return driver.findElements(resultItems).get(0);}
    ...
    public void clickWishHeart(){driver.findElement(wishHeart).click();}
