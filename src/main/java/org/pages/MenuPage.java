...
public class MenuPage extends BasePage {
    ...
    private By wishListHeartElement= By.xpath("//*[@id=\"entry_217824\"]/a");
    ...
    public void clickWishListHeartElement(){driver.findElement(wishListHeartElement).click();}
    public String getErrorMessage(){return driver.findElement(errorMessage).getText();}
    public void enterTextSearch(String searchText){driver.findElement(searchInput).sendKeys(searchText);}
    public void clickSpecialOffers(){driver.findElement(specialOffers).click();}
    public String getMessageSpecialOffers(){return driver.findElement(messageSpecialOffers).getText();}
    public void clickBlog(){driver.findElement(blog).click();}
    public void clickFirstItem(){driver.findElement(firstItem).click();}
    public void insertTextToYourName(String s ){driver.findElement(yourName).sendKeys(s);}
    public void insertTextToEmail(String s){driver.findElement(email).sendKeys(s);}
    public void insertTextToYourComment(String s){driver.findElement(yourComment).sendKeys(s);}
    public void clickPostComment (){driver.findElement(postComment).click();}
    public String getApprovalComment(){return driver.findElement(approvalComment).getText();}
    public void clickSearch(){driver.findElement(search).click();}
    public void enterText(String s){driver.findElement(text).sendKeys(s);}
    public void clickSearchButton(){driver.findElement(searchButton).click();}
    public String getNoResult(){return driver.findElement(noResult).getText();}
}
