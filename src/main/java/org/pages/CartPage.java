...
public class CartPage extends  BasePage{
    ...
    private By selectAustralianCapitalTerritory= By.xpath("//*[@id=\"input-zone\"]/option[2]");
    ...
    public void clickApplyShpping(){driver.findElement(applyShipping).click();}
    public void enterTextToSearch(String s) {driver.findElement(searchProducts).sendKeys(s);}
    public void clickFlatRate(){driver.findElement(flatRate).click();}
    public void clickSearchForProducts(){driver.findElement(searchProducts).click();}
    public void clickAddToCartButton(){driver.findElement(addToCartButton).click();}
    public void clickCartIcon(){driver.findElement(cartIcon).click();}
    public void clickFirstItem(){driver.findElement(firstItem).click();}
    public String getTotalToPay(){return driver.findElement(totalToPay).getText();}
    public void clickPopUpButton(){driver.findElement(popUpButton).click();}
    public void clickEditCartButton(){driver.findElement(editCartButton).click();}
    //public void clickEditQuantity(){driver.findElement(editQuantity).click();}
    public void clearEditQuantity(){driver.findElement(editQuantity).clear();}
    public void enterTextToQuantity(String s){driver.findElement(editQuantity).sendKeys(s);}
    public void clickUpdateButton(){driver.findElement(updateButton).click();}
    public String getConfirmModifiedCart(){return driver.findElement(confirmModifiedCart).getText().split("\n")[0];}
    public void clickUseCouponCode(){driver.findElement(useCouponCode).click();}
    public void clickEnterCoupon(){driver.findElement(enterCoupon).click();}
    public void enterTextToCoupon(String s){driver.findElement(enterCoupon).sendKeys(s);}
    public void clickApplyCoupon(){driver.findElement(applyCoupon).click();}
    public String getWarningMessage(){return driver.findElement(warningMessage).getText().split("\n")[0];}
    public void clickEstimateShipping(){driver.findElement(estimateShipping).click();}
    ...
    public void clickSelectRegion(){driver.findElement(selectRegion).click();}
    public void clickSelectAustralianCapitalTerritory(){driver.findElement(selectAustralianCapitalTerritory).click();}
    public void clickGetQuotes(){driver.findElement(getQuotes).click();}
    public String getConfirmMessage(){return driver.findElement(confirmMessage).getText().split("\n")[0];}
    public void clickUseGiftCertificate(){driver.findElement(useGiftCertificate).click();}
    public void clickInputGiftCode(){driver.findElement(inputGiftCode).click();}
    public void enterTextToGiftCode(String s){driver.findElement(inputGiftCode).sendKeys(s);}
    public void clickApplyCertificate(){driver.findElement(applyCertificate).click();}
    public String getWarningCertificate(){return driver.findElement(warningCertificate).getText().split("\n")[0];}
