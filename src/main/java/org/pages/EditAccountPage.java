...
public class EditAccountPage extends BasePage {
    public EditAccountPage(WebDriver driver) {super(driver);}
    ...
    public void clearFirstName(){driver.findElement(firstNameInput).clear();}
    ...
    public void clearLastName(){driver.findElement(lastNameInput).clear();}
    public void insertLastName(String lastName){driver.findElement(lastNameInput).sendKeys(lastName);}
    public void clearEditEmailAddress(){driver.findElement(editEmailAddress).clear();}
    public void insertEditEmailAddress(String editEmailAddressText){driver.findElement(editEmailAddress).sendKeys(editEmailAddressText);}
    public void clearEditTelephone(){driver.findElement(editTelephone).clear();}
    public void insertEditTelephone(String editTelephoneNumber){driver.findElement(editTelephone).sendKeys(editTelephoneNumber);}
    public String getWarningEmailRegistered(){return driver.findElement(warningEmailRegistered).getText();}
