...
public class CheckoutPage extends BasePage {
    ...
    public void enterAddressOne(String s) {
        driver.findElement(addressOne).sendKeys(s);
    }
    ...
    public void selectRegion(String s) {
        Select dropdown = new Select(driver.findElement(region));
        dropdown.selectByVisibleText(s);
    }
    ...
    public void enterTelephone(String s) {
